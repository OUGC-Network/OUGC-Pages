...
{
	global $db, $ougc_pages, $lang, $templates, $mybb, $footer, $headerinclude, $header, $theme, $pages, $category;
	...
	$lang->load('ougc_pages_'.$pages['pid'], false, true);
	...
	{
		$title = $lang->sprintf($lang->ougc_pages_category_list, $category['name']);
